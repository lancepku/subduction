...
if(incoming_left==1) then
 ...
 !   add new phase on the left !LIU 2017
    call newphase2marker(1, 2, 1, 1+idist, iph_col1(1))
    call newphase2marker(3, 4, 1, 1+idist, inphase(1))
    call newphase2marker(5, 6, 1, 1+idist, inphase(2))
    call newphase2marker(7, 8, 1, 1+idist, inphase(3))
    call newphase2marker(9, 10, 1, 1+idist, inphase(4))
    call newphase2marker(11, nz-1, 1, 1+idist, iph_col2(1))
endif
